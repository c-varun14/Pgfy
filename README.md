...
- External alerts, a second factor for the dashboard, host-side admin reset,
  credential rotation, connection budgets, project deletion, and the other items in the post-hackathon
